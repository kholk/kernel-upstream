...
struct msm_iommu_powerdata {
	struct device *power_domains[MMU_POWER_DOMAINS_CNT];
	char *power_domain_names[MMU_POWER_DOMAINS_CNT];
};
...
struct msm_iommu_drvdata {
	...
	unsigned int model;
	//struct msm_iommu_powerdata power_data;
